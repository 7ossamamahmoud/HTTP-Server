...
namespace HTTPServer
{
    static class Configuration
    {
        ...
        public static string RootPath = "C:\\inetpub\\wwwroot\\fcis1"; // take files from it that  i need
        ...
        public static string InternalErrorDefaultPageName = "InternalError.html";//500
